...
export default function JarvisOrb() {
  ...
  const voice = useVoiceAgent({
    onVoiceLevel: (level) => sceneRef.current?.setVoiceLevel(level),
  });
  ...
  return (
    <>
      ...
      <div className="hud hud-title">E.L.I.S.A.</div>
      ...
      <div className="hud hud-controls">
        ...
        <div className="hud-row">
          <button
            ...
            onClick={voice.state === "connected" ? voice.disconnect : () => void voice.connect()}
        ...
        {voice.error && <div className="hud-error">{voice.error}</div>}
